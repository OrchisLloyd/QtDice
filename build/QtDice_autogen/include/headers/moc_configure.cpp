...
#include "../../../../src/headers/configure.h"
...
QT_MOC_LITERAL(1, 10, 15), // "checkBoxToggled"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 17), // "soundCheckUnsaved"
QT_MOC_LITERAL(4, 45, 4), // "show"
QT_MOC_LITERAL(5, 50, 13), // "writeSettings"
QT_MOC_LITERAL(6, 64, 17) // "isCheckBoxUnsaved"

    },
    "Configure\0checkBoxToggled\0\0soundCheckUnsaved\0"
    "show\0writeSettings\0isCheckBoxUnsaved"
};
...
void Configure::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->soundCheckUnsaved(); break;
        case 2: _t->show(); break;
        case 3: _t->writeSettings(); break;
        case 4: { bool _r = _t->isCheckBoxUnsaved();
        ...
        {
            using _t = void (Configure::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Configure::checkBoxToggled)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Configure::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Configure::soundCheckUnsaved)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Configure::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_Configure.data,
    qt_meta_data_Configure,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void Configure::checkBoxToggled()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Configure::soundCheckUnsaved()
{
